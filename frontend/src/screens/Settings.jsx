        ...
        <div className="flex flex-col h-full border border-gray-300 min-w-80 max-w-80 bg-[#F7F8F9]">
          ...
          <div className="flex items-center gap-4 pt-8 p-4">
            ...
            <div className="font-medium ">
              ...
              <div className="text-xs text-[#1D2226] ">
                Marry@gmail.com
              </div>
            </div>
          </div>
          <p className="p-4 pt-4 text-sm">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Odio alias tenetur veritatis error, adipisci distinctio?</p>
